  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Current Ride</h2>
        ...
        <div className="flex flex-col space-y-2">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-white">{currentRide.pickup}</p>
            </div>
          </div>
          <div className="flex items-center">
            <div className="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-white">{currentRide.destination}</p>
            </div>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4 py-4 border-t border-b border-gray-300 dark:border-gray-600">
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">Distance</p>
            <p className="text-sm font-medium text-gray-900 dark:text-white">{currentRide.distance}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">Duration</p>
            <p className="text-sm font-medium text-gray-900 dark:text-white">{currentRide.duration}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">Fare</p>
            <p className="text-sm font-medium text-gray-900 dark:text-white">₹{currentRide.fare.toFixed(2)}</p>
          </div>
          <div>
          ...
          <div className="mt-6 space-y-3">
            {currentRide.status === 'booked' && (
              <button
                ...
                className="w-full py-2 px-4 rounded-md text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-900"
              >
                Start Ride
              </button>
            )}
            {currentRide.status === 'ongoing' && (
              <button
                ...
                className="w-full py-2 px-4 rounded-md text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-900 disabled:opacity-50"
              >
